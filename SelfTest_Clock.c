...
* clock source testing according to the Class B library for PSoC 4.
*
* Related Document:
...
void SelfTest_Clock_ISR_TIMER(void)
{
    ...
    Cy_TCPWM_ClearInterrupt(CYBSP_CLOCK_TEST_TIMER_HW, CYBSP_CLOCK_TEST_TIMER_NUM,
                            CY_TCPWM_INT_ON_TC);
