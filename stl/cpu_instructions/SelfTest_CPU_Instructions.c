/*******************************************************************************
* File Name: SelfTest_CPU_Instructions.c
*
* Description:
*  This file provides the source code for the CPU instructions self tests.
*
*******************************************************************************
...
uint8_t SelfTest_CPU_Instructions(void)
{
    ...
    ret = SelfTest_CPU_Instructions_ARM();
    #elif defined(__GNUC__) && !defined(__clang__)
    ret = SelfTest_CPU_Instructions_GCC();
    #elif defined(__ICCARM__)
    ret = SelfTest_CPU_Instructions_IAR();
    #else
    ret = ERROR_STATUS;
    #endif
