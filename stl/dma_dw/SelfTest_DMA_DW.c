...
static uint8_t data_dst_1[64];          /* Descriptor_0 Data Transfer destination */
/*******************************************************************************
...
#endif
{
    ...
    // Init Descriptors
    Cy_DMA_Descriptor_Init(descriptor0, des0_config);
    Cy_DMA_Descriptor_Init(descriptor1, des1_config);
    ...
    Cy_DMA_Channel_Init(base, channel, channelConfig);
	...
	while(!Cy_DMA_Channel_GetInterruptStatus(base,channel))
	{
